...
import { SupervisorCard, supervisorCardStyles } from './SupervisorCard';
          ...
          <Table size="small">
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={supervisorCardStyles.headerCell}>User</TableCell>
                <TableCell sx={supervisorCardStyles.headerCell}>
                  Training
                </TableCell>
                <TableCell sx={supervisorCardStyles.headerCell}>Date</TableCell>
                <TableCell sx={supervisorCardStyles.headerCell}>
                  Actions
                </TableCell>
              </TableRow>
